...
- [ ] T020 Implement hypotheses scoring in `tools/model-eval.mjs`: context use, restraint on f06 (guessing is a failure not a near-miss), 0–3 schema adherence, evidence-pointer validity rate, anchoring resistance on f08, latency
